    ...
    <ScreenShell className="items-center justify-center bg-black/60 backdrop-blur-sm">
      <Panel className="w-[min(420px,92vw)] p-8 text-center">
        ...
        <div className="mt-5 grid grid-cols-2 gap-x-8 gap-y-2 text-left text-sm text-white/70">
          <span className="text-white/40">WASD</span><span>Fly / strafe</span>
          <span className="text-white/40">Mouse</span><span>Aim</span>
          <span className="text-white/40">L-Click</span><span>Pulse Cannon</span>
          <span className="text-white/40">R-Click / R</span><span>Rift Missile</span>
          <span className="text-white/40">Space</span><span>Boost</span>
          <span className="text-white/40">E</span><span>EMP Burst</span>
